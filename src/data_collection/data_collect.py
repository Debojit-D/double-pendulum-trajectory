...
#  - One CSV per run (same columns as before)
...
OUTPUT_DIR   = "/home/iitgn-robotics/Debojit_WS/double-pendulum-trajectory/data/SampleIdeal1"
...
def main():
    ...
    manifest = {
        ...
        "regime": {"tag": tag, "damping": float(damping), "frictionloss": float(frictionloss)},
